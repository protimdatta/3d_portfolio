...
// variant.
// DISABLED movesTarget: applying transforms to interactive elements (buttons, links)
// causes layout instability and hydration mismatches across browsers.
const wrapsTarget = true;
const movesTarget = false;
